...
void main() {
  ...
  testWidgets('Initial camera position', (WidgetTester tester) async {
    ...
    expect(map.widgetConfiguration.initialCameraPosition, const CameraPosition(target: LatLng(10.0, 15.0)));
  });
  ...
  testWidgets('Can update style', (WidgetTester tester) async {
    ...
    expect(map.mapConfiguration, initialStyle);
